...
bool SDMMCFS::begin(const char * mountpoint, bool mode1bit, bool format_if_mount_failed)
{
...
#endif
    if(mode1bit) {
        log_w("SDMMC 1 bit flag enabled");
        slot_config.flags = SDMMC_HOST_FLAG_1BIT; //use 1-line SD mode
        slot_config.width = 1;
    }
    ...
    esp_vfs_fat_sdmmc_mount_config_t mount_config = {
        ...
        .max_files = 5,
        .allocation_unit_size = 64 * 1024 // recommended default from ESP32 IDF examples
    };
